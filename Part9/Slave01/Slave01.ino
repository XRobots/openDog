        ...
        //**************** do the other leg *****************
          ...
          */
          ...
          if (flag == 5) {        // main output to leg starts here
                ...
                Serial.print(mydata_back.elbowR);    // print original test value
                Serial.print(" , ");
                elbowRFiltered = filter(mydata_back.elbowR, elbowRFiltered);
                Serial.print(elbowRFiltered);  
                Serial.print(" , ");  
                Serial.print(mydata_back.elbowL);    // print original test value
                Serial.print(" , ");
                elbowLFiltered = filter(mydata_back.elbowL, elbowLFiltered);
                Serial.print(elbowLFiltered);
                Serial.print(" , ");
                ...
                Serial.print(hipLOutput);
                Serial.print(" , ");
                Serial.println(hipROutput);
