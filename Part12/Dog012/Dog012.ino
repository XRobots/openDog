       ...
       if (currentMillis - previousMillis >= interval) {  // start timed event for read and send
            ...
            if (mode == 2) {
                  ...
                  if (gaitFlag1 == 0) {         
                    ...
                    leg4Z = Gait1Z(4);
                    //*******
                    leg4Y = Gait1Y(4, leg4Y, RFB);
                    gaitFlag1 = 2;
                    previousGait1Millis = currentMillis;                                     // when this is done the delay comes from the next 'if' statement
                    }
                  else if (gaitFlag1 == 2 && currentMillis - previousGait1Millis > 500){    // wait for this amount of time and then do the things in here
                    //do some stuff
                    // ******************* LEAN OVER **************************************
                    Gait1X = -120;
                    gaitFlag1 = 3;
                  ...
                  else if (gaitFlag1 == 3 && currentMillis - previousGait1Millis > 1200){    // wait extra time for leaing
                    //do some stuff
                    leg1Z = Gait1Z(2);                                                       // ** LIFTS FIRST FOOT **
                    leg2Z = Gait1Z(6);
                    leg3Z = Gait1Z(5);
                    leg4Z = Gait1Z(4);
                    //*******
                    leg1Y = Gait1Y(2, leg1Y, RFB);
                    gaitFlag1 = 4;
                    ...
                    leg4Z = Gait1Z(5);
                    //*******
                    leg1Y = Gait1Y(3, leg1Y, RFB);
                    leg2Y = Gait1Y(1, leg2Y, RFB);
                    leg3Y = Gait1Y(6, leg3Y, RFB);
                    leg4Y = Gait1Y(5, leg4Y, RFB);
                    gaitFlag1 = 5;
                    previousGait1Millis = currentMillis;
                  }
                  else if (gaitFlag1 == 5 && currentMillis - previousGait1Millis > 500){
                    //do some stuff
                    leg1Z = Gait1Z(4);
                    leg2Z = Gait1Z(1);
                    leg3Z = Gait1Z(6);
                    leg4Z = Gait1Z(5);
                    //*******
                    leg1Y = Gait1Y(4, leg1Y, RFB);
                    gaitFlag1 = 6;
                    previousGait1Millis = currentMillis;
                  }
                  else if (gaitFlag1 == 6 && currentMillis - previousGait1Millis > 500){
                    //do some stuff
                    leg1Z = Gait1Z(4);
                    leg2Z = Gait1Z(2);                                                        // ** LIFTS SECOND FOOT **
                    leg3Z = Gait1Z(6);
                    leg4Z = Gait1Z(5);
                    //*******
                    leg2Y = Gait1Y(2, leg2Y, RFB);
                    gaitFlag1 = 7;
                    previousGait1Millis = currentMillis;
                  }
                  else if (gaitFlag1 == 7 && currentMillis - previousGait1Millis > 500){
                    //do some stuff
                    leg1Z = Gait1Z(5);
                    leg2Z = Gait1Z(3);
                    leg3Z = Gait1Z(1);
                    leg4Z = Gait1Z(6);
                    //*******
                    leg1Y = Gait1Y(5, leg1Y, RFB);
                    leg2Y = Gait1Y(3, leg2Y, RFB);
                    leg3Y = Gait1Y(1, leg3Y, RFB);
                    leg4Y = Gait1Y(6, leg4Y, RFB);
                    gaitFlag1 = 8;
                    previousGait1Millis = currentMillis;
                  }
                  else if (gaitFlag1 == 8 && currentMillis - previousGait1Millis > 500){
                    //do some stuff
                    leg1Z = Gait1Z(5);
                    leg2Z = Gait1Z(4);
                    leg3Z = Gait1Z(1);
                    leg4Z = Gait1Z(6);
                    //*******
                    leg2Y = Gait1Y(4, leg2Y, RFB);
                    gaitFlag1 = 9;
                    previousGait1Millis = currentMillis;
                  }
                  else if (gaitFlag1 == 9 && currentMillis - previousGait1Millis > 500){
                    //do some stuff
                    // ******************* LEAN OVER **************************************
                    Gait1X = 120;
                    gaitFlag1 = 10;
                  ...
                  else if (gaitFlag1 == 10 && currentMillis - previousGait1Millis > 1200){     // wait extra time for leaing
                    //do some stuff
                    leg1Z = Gait1Z(5);
                    leg2Z = Gait1Z(4);
                    leg3Z = Gait1Z(2);                                                          // ** LIFTS THIRD FOOT **
                    leg4Z = Gait1Z(6);
                    //*******
                    leg2Y = Gait1Y(2, leg3Y, RFB);
                    gaitFlag1 = 11;
                    previousGait1Millis = currentMillis;
                  }
                  else if (gaitFlag1 == 11 && currentMillis - previousGait1Millis > 500){
                    //do some stuff
                    leg1Z = Gait1Z(6);
                    leg2Z = Gait1Z(5);
                    leg3Z = Gait1Z(3);
                    leg4Z = Gait1Z(1);
                    //*******
                    leg1Y = Gait1Y(6, leg1Y, RFB);
                    leg2Y = Gait1Y(5, leg2Y, RFB);
                    leg3Y = Gait1Y(3, leg3Y, RFB);
                    leg4Y = Gait1Y(1, leg4Y, RFB);
                    gaitFlag1 = 12;
                    previousGait1Millis = currentMillis;
                  }
                  else if (gaitFlag1 == 12 && currentMillis - previousGait1Millis > 500){
                    //do some stuff
                    leg1Z = Gait1Z(6);
                    leg2Z = Gait1Z(5);
                    leg3Z = Gait1Z(4);
                    leg4Z = Gait1Z(1);
                    //*******
                    leg3Y = Gait1Y(4, leg3Y, RFB);
                    gaitFlag1 = 13;
                    previousGait1Millis = currentMillis;
                  }
                  else if (gaitFlag1 == 13 && currentMillis - previousGait1Millis > 500){
                    //do some stuff
                    leg1Z = Gait1Z(6);
                    leg2Z = Gait1Z(5);
                    leg3Z = Gait1Z(4);
                    leg4Z = Gait1Z(2);                                                           // ** LIFTS FORTH FOOT **
                    //*******
                    leg4Y = Gait1Y(2, leg4Y, RFB);
                    gaitFlag1 = 14;
                    previousGait1Millis = currentMillis;
                  }else if (gaitFlag1 == 14 && currentMillis - previousGait1Millis > 500){
                    //do some stuff
                    leg1Z = Gait1Z(1);
                    leg2Z = Gait1Z(6);
                    leg3Z = Gait1Z(5);
                    leg4Z = Gait1Z(3);
                    //*******
                    leg1Y = Gait1Y(1, leg1Y, RFB);
                    leg2Y = Gait1Y(6, leg2Y, RFB);
                    leg3Y = Gait1Y(5, leg3Y, RFB);
                    leg4Y = Gait1Y(3, leg4Y, RFB);
                    gaitFlag1 = 1;
                    previousGait1Millis = currentMillis;
                  }
                  ...
                  Serial.print(leg4Y);
                  Serial.print(" , ");
                  Serial.println(Gait1X);

                  leg(leg1Z, 0, Gait1X, 0, 0, 0, 0, 1); // left front leg
                  leg(leg2Z, 0, Gait1X, 0, 0, 0, 0, 0); // left back leg
                  leg(leg3Z, 0, Gait1X, 0, 0, 0, 1, 1); // right front leg
                  leg(leg4Z, 0, Gait1X, 0, 0, 0, 1, 0); // right back leg                  
...
int Gait1Z(int pos){
  ...
  if (pos == 2 || pos == 3) {
    Z = 540;    // make leg shorter
  }
  else {
    Z = 640;    // make leg longer
  }
...
int Gait1Y(int pos, int curPos, int stick) {      // takes the postion in teh sequence, the current Y leg position, and the right hand FB stick
  int Y;      // output Y axis position based on zero point, current leg Y position and bias from RFB stick position

  stick = (stick / 4) * -1;  // make the stick value smaller so the steps are the right size
  

  if (pos == 1) {
    Y = curPos - (stick * 2);   // move back in Y
  }
  else if (pos == 2) {
    Y = curPos + (stick * 2);   // move forwards in Y
  }
  else if (pos == 3) {          // ** move +/- relative to zero **
    Y = stick;
  }
  else if (pos == 4) {          // move forward in Y
    Y = curPos + (stick * 2);
  }
  else if (pos == 5) {          // move back in Y
    Y = curPos - (stick * 2);   
  }
  else if (pos == 6) {          // move back in Y
    Y = curPos - (stick * 2);
  }
  else if (pos == 7) {          // move back in Y
    Y = curPos - (stick * 2);
  }
